...
Original file is located at
    https://colab.research.google.com/drive/1BDgtVjtApzI1bVNDBluNrNwWp-o0bWtN
"""
...
# Load training data
# train_data_path = f'/content/drive/MyDrive/psl_project3/split_{split}/train.tsv'
...
# Load test data
# test_data_path = f'/content/drive/MyDrive/psl_project3/split_{split}/test.tsv'
...
result_df.to_csv('mysubmission.csv', columns=['id', 'probability'], header=['id', 'prob'], index=False)
